...
#ifndef _MKTDATA_MDINCREMENTALREFRESHTRADE36_HPP_
#define _MKTDATA_MDINCREMENTALREFRESHTRADE36_HPP_
...
public:
    ...
    MDIncrementalRefreshTrade36(void) : buffer_(NULL), bufferLength_(0), offset_(0) {}

    MDIncrementalRefreshTrade36(char *buffer, const int bufferLength, const int actingBlockLength, const int actingVersion)
    {
    ...
    MDIncrementalRefreshTrade36 &wrapForEncode(char *buffer, const int offset, const int bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    MDIncrementalRefreshTrade36 &wrapForDecode(char *buffer, const int offset, const int actingBlockLength, const int actingVersion, const int bufferLength)
    {
    ...
    MDIncrementalRefreshTrade36 &transactTime(const sbe_uint64_t value)
    {
...
public:
        ...
        static const int tradeIDId(void)
        {
            return 1003;
        }

        static const int tradeIDSinceVersion(void)
        {
             return 0;
        }
        ...
        static const sbe_int32_t tradeIDNullValue()
        {
            return SBE_NULLVALUE_INT32;
        }

        static const sbe_int32_t tradeIDMinValue()
        {
            return -2147483647;
        }

        static const sbe_int32_t tradeIDMaxValue()
        {
            return 2147483647;
        }

        sbe_int32_t tradeID(void) const
        {
            return SBE_LITTLE_ENDIAN_ENCODE_32(*((sbe_int32_t *)(buffer_ + offset_ + 24)));
        }

        NoMDEntries &tradeID(const sbe_int32_t value)
        {
        ...
        {
            return AggressorSide::get((*((sbe_uint8_t *)(buffer_ + offset_ + 28))));
        }
        ...
        {
            return MDUpdateAction::get((*((sbe_uint8_t *)(buffer_ + offset_ + 29))));
        }
