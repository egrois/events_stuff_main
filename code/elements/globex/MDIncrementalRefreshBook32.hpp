...
#ifndef _MKTDATA_MDINCREMENTALREFRESHBOOK32_HPP_
#define _MKTDATA_MDINCREMENTALREFRESHBOOK32_HPP_
...
public:
    ...
    MDIncrementalRefreshBook32(void) : buffer_(NULL), bufferLength_(0), offset_(0) {}

    MDIncrementalRefreshBook32(char *buffer, const int bufferLength, const int actingBlockLength, const int actingVersion)
    {
    ...
    MDIncrementalRefreshBook32 &wrapForEncode(char *buffer, const int offset, const int bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    MDIncrementalRefreshBook32 &wrapForDecode(char *buffer, const int offset, const int actingBlockLength, const int actingVersion, const int bufferLength)
    {
    ...
    MDIncrementalRefreshBook32 &transactTime(const sbe_uint64_t value)
    {
...
public:
        ...
        static const sbe_uint8_t mDPriceLevelNullValue()
        {
            return SBE_NULLVALUE_UINT8;
        }

        static const sbe_uint8_t mDPriceLevelMinValue()
        {
            return (sbe_uint8_t)0;
        }

        static const sbe_uint8_t mDPriceLevelMaxValue()
        {
            return (sbe_uint8_t)254;
        }

        sbe_uint8_t mDPriceLevel(void) const
        {
            return (*((sbe_uint8_t *)(buffer_ + offset_ + 24)));
        }

        NoMDEntries &mDPriceLevel(const sbe_uint8_t value)
        {
        ...
        {
            return MDEntryTypeBook::get((*((sbe_char_t *)(buffer_ + offset_ + 26))));
        }

        NoMDEntries &mDEntryType(const MDEntryTypeBook::Value value)
        {
            *((sbe_char_t *)(buffer_ + offset_ + 26)) = (value);
            return *this;
        }
    };
