...
#ifndef _MKTDATA_FLOAT_HPP_
#define _MKTDATA_FLOAT_HPP_
...
public:
    FLOAT(void) : buffer_(NULL), offset_(0) {}

    FLOAT(char *buffer, const int bufferLength, const int actingVersion)
    {
    ...
    FLOAT &wrap(char *buffer, const int offset, const int actingVersion, const int bufferLength)
    {
    ...
    FLOAT &mantissa(const sbe_int64_t value)
    {
